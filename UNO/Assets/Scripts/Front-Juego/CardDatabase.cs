...
public class CardDatabase : MonoBehaviour
{
    ...
    {   
        /************************************* ROJAS ******************************************/
        cardList.Add(new Card(0,-2,"Rojo","Intermision",Load("spritesheet_uno", "spritesheet_uno_0")));
        cardList.Add(new Card(1,-3,"Rojo","Retorno",Load("spritesheet_uno", "spritesheet_uno_1")));
        cardList.Add(new Card(2,-4,"Rojo","Toma dos",Load("spritesheet_uno", "spritesheet_uno_2")));
        ...
        /********************************** AMARILLAS ******************************************/
        cardList.Add(new Card(14,-2,"Amarillo","Intermision",Load("spritesheet_uno", "spritesheet_uno_14")));
        cardList.Add(new Card(15,-3,"Amarillo","Retorno",Load("spritesheet_uno", "spritesheet_uno_15")));
        cardList.Add(new Card(16,-4,"Amarillo","Toma dos",Load("spritesheet_uno", "spritesheet_uno_16")));
        ...
        /********************************** VERDES ********************************************/
        cardList.Add(new Card(28,-2,"Verde","Intermision",Load("spritesheet_uno", "spritesheet_uno_28")));
        cardList.Add(new Card(29,-3,"Verde","Retorno",Load("spritesheet_uno", "spritesheet_uno_29")));
        cardList.Add(new Card(30,-4,"Verde","Toma dos",Load("spritesheet_uno", "spritesheet_uno_30")));
        ...
        /**************************************************************************************/
        cardList.Add(new Card(41,-1,"Parte de atras","nada",Load("xd", "xd")));

        /********************************** AZULES ********************************************/
        cardList.Add(new Card(42,-2,"Azul","Intermision",Load("spritesheet_uno", "spritesheet_uno_42")));
        cardList.Add(new Card(43,-3,"Azul","Retorno",Load("spritesheet_uno", "spritesheet_uno_43")));
        cardList.Add(new Card(44,-4,"Azul","Toma dos",Load("spritesheet_uno", "spritesheet_uno_44")));
